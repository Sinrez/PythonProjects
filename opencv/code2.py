...
# Кнопки
takeoff_button = tk.Button(window, text="Взлет", width=20, bg="green", fg="white", relief="solid", activebackground="silver", command=takeoff).grid(row=6, column=0, padx=20, pady=10)
land_button = tk.Button(window, text="Посадка", width=20, bg="red", fg="white", relief="solid", activebackground="silver", command=land_drone).grid(row=7, column=0, padx=20, pady=10)
...
load_plan_button = tk.Button(window, text="Загрузить План", width=20, relief="solid", activebackground="silver", bg="blue", fg="white", command=browse_files).grid(row=8, column=2, padx=20, pady=10)
run_plan_button = tk.Button(window, text="Активировать План", width=20, relief="solid", activebackground="silver", bg="blue", fg="white", command=fly_by_plan).grid(row=8, column=3, padx=20, pady=10)
...
tk.Button(window, text="Распознать объекты", width=20, bg="green", fg="white", command=start_object_detection).grid(row=6, column=2, padx=20, pady=10)
tk.Button(window, text="Остановить распознание", width=20, bg="red", fg="white", command=stop_detection).grid(row=7, column=2, padx=20, pady=10)
...
# Остальные кнопки
record_telemetry_button = tk.Button(window, text="Запись телеметрии", width=20, relief="solid", activebackground="silver", bg="blue", fg="white", command=start_telemetry_recording).grid(row=6, column=1, padx=20, pady=10)
